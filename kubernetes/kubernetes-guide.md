...
* [Kubernetes: A Complete Guide](#kubernetes-a-complete-guide)
  ...
  * [Library Events Producer — Quick Setup & Teardown](#library-events-producer--quick-setup--teardown)
    * [Setup](#setup)
    * [Teardown](#teardown)
  * [Section 11: Library Events Consumer](#section-11-library-events-consumer)
    * [ConfigMap](#configmap)
    * [Deployment](#deployment)
    * [Service](#service)
    * [Ingress](#ingress)
    * [Add Hostname to /etc/hosts](#add-hostname-to-etchosts)
    * [Access via Ingress](#access-via-ingress)
    * [Delete All](#delete-all)
    * [Secret](#secret)
      * [What is a Kubernetes Secret?](#what-is-a-kubernetes-secret)
      * [Why use Secrets instead of ConfigMaps or env vars?](#why-use-secrets-instead-of-configmaps-or-env-vars)
      * [How Kubernetes handles the value](#how-kubernetes-handles-the-value)
